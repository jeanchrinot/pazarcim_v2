    ...
    <div class="row">
      ...
      <div class="category-description std">
        ...
        <article>
          <div class="toolbar">
            <div class="sorter">
              <div class="view-mode"> <span title="Grid" class="button button-active button-grid">&nbsp;</span><a title="List" class="button-list">&nbsp;</a> </div>
            </div>
            <div class="sort-by">
          ...
          <div class="category-products hidden" id="list">
