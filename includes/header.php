        ...
        <div class="header-banner">
          <div class="assetBlock">
            <div id="slideshow">
              ...
              <p>Ramazan <span>özel</span> indirimleri </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="header-container row">
          <div class="logo"> <a href="index.php" title="index">
            <div><img src="images/plogo.jpg" alt="logo" style="width:100px"></div>
            </a> </div>
          <div class="fl-nav-menu">
            <nav>
              <div class="mm-toggle-wrap">
                <div class="mm-toggle"><i class="icon-align-justify"></i><span class="mm-label">Menü</span> </div>
              </div>
              <div class="nav-inner">
                <!-- BEGIN NAV -->
